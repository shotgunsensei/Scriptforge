# Kaseya / Datto RMM RMM Disk Capacity Snapshot

Read-only Kaseya / Datto RMM script for rmm disk capacity snapshot.
...
```powershell
./kaseya-datto-rmm-rmm-disk-capacity-snapshot.ps1
```
