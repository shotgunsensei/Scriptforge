# Kaseya / Datto RMM RMM Application Event Review

Read-only Kaseya / Datto RMM script for rmm application event review.
...
```powershell
./kaseya-datto-rmm-rmm-application-event-review.ps1
```
