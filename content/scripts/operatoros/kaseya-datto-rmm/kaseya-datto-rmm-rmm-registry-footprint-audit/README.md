# Kaseya / Datto RMM RMM Registry Footprint Audit

Read-only Kaseya / Datto RMM script for rmm registry footprint audit.
...
```powershell
./kaseya-datto-rmm-rmm-registry-footprint-audit.ps1
```
