# Kaseya / Datto RMM RMM ProgramData Footprint Audit

Read-only Kaseya / Datto RMM script for rmm programdata footprint audit.
...
```powershell
./kaseya-datto-rmm-rmm-programdata-footprint-audit.ps1
```
