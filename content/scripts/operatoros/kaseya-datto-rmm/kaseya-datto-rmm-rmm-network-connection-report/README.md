# Kaseya / Datto RMM RMM Network Connection Report

Read-only Kaseya / Datto RMM script for rmm network connection report.
...
```powershell
./kaseya-datto-rmm-rmm-network-connection-report.ps1
```
