# Windows Server Top Process Resource Report

Read-only Windows Server script for top process resource report.
...
```powershell
./windows-server-top-process-resource-report.ps1
```
