# Active Directory Replication Failure Report

Read-only Active Directory script for replication failure report.
...
```powershell
./active-directory-replication-failure-report.ps1
```
