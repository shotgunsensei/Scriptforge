# Workstation Repair Workstation Inventory Report

Read-only Workstation Repair script for workstation inventory report.
...
```powershell
./workstation-repair-workstation-inventory-report.ps1
```
