# Workstation Repair Printer Inventory Report

Read-only Workstation Repair script for printer inventory report.
...
```powershell
./workstation-repair-printer-inventory-report.ps1
```
