# Workstation Repair Application Error Review

Read-only Workstation Repair script for application error review.
...
```powershell
./workstation-repair-application-error-review.ps1
```
