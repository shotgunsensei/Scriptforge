# Exchange Online Inbox Rule Forwarding Audit

Read-only Exchange Online script for inbox rule forwarding audit.
...
```powershell
./exchange-online-inbox-rule-forwarding-audit.ps1
```
