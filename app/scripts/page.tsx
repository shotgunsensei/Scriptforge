...
export const metadata: Metadata = {
  title: "PowerShell Script Library | OperatorOS ScriptForge",
  description:
    "Browse approved OperatorOS and community PowerShell scripts with safety metadata, review status, and category filters.",
  alternates: {
    canonical: "/scripts",
  },
};
